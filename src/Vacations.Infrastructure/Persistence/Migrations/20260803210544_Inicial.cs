        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CamposModificados = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SaldosEmpleados", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HistorialSolicitudes_SolicitudId_Timestamp",
                table: "HistorialSolicitudes",
                columns: new[] { "SolicitudId", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_SaldosEmpleados_EmpleadoId",
