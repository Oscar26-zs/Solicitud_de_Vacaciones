...
public sealed class RechazarSolicitudCommandHandler
{
    ...
    public async Task HandleAsync(RechazarSolicitudCommand command, CancellationToken cancellationToken = default)
    {
        ...
        solicitud.Rechazar(command.AprobadorId, command.Comentario, ahora);
